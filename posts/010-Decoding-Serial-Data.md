...
<figure>
<img loading="lazy" width="200" src="../Images/lds-006/cardboardMod.jpg" alt="" style="border:1px solid black;"/>
...
<figure>
<img loading="lazy" width="400" src="../Images/lds-006/buckConverter.jpg" alt="" style="border:1px solid black;"/>
<figcaption style="font-style: italic;">
</figcaption>
</figure>
...
<figure>
<img loading="lazy" width="400" src="../Images/lds-006/laserOnCardboard.jpg" alt="" style="border:1px solid black;"/>
<figcaption style="font-style: italic;">
</figcaption>
</figure>
...
<figure>
<img loading="lazy" width="500" src="../Images/lds-006/firstData.jpg" alt="" style="border:1px solid black;"/>
<figcaption style="font-style: italic;">
</figcaption>
</figure>
...
<figure>
<img loading="lazy" width="500" src="../Images/lds-006/secondData.jpg" alt="" style="border:1px solid black;"/>
<figcaption style="font-style: italic;">
</figcaption>
</figure>
...
<figure>
<img loading="lazy" width="700" src="../Images/lds-006/thirdData.jpg" alt="" style="border:1px solid black;"/>
<figcaption style="font-style: italic;">
</figcaption>
</figure>
...
<figure>
<img loading="lazy" width="700" src="../Images/lds-006/forthData.jpg" alt="" style="border:1px solid black;"/>
<figcaption style="font-style: italic;">
</figcaption>
</figure>
...
<figure>
<img loading="lazy" width="300" src="../Images/lds-006/lightBlockerThings.jpg" alt="" style="border:1px solid black;"/>
<figcaption style="font-style: italic;">
</figcaption>
</figure>
...
- My job now is to properly read the data coming from the IR receiver to see if it is the same as the data being sent over serial; if it is then I can be sure that these packets contain the distance data somehow
  ...
  - I plan to create a template for the fork sensor to mimic the spinning (like a circle of cardboard with cutouts corresponding to the ones on the assembly), and read the data sent by the IR led by spinning the template through the fork sensor. This is a lot easier than probing the IR receiver on an assembled LIDAR module, and also allows for fine grained control of speed and also easier changing of distance (since I don't need to do the cardboard extension trick from above)